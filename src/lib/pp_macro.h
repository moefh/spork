...
typedef int sp_token_reader(struct sp_preprocessor *pp, struct sp_token *tok, void *reader_data);
...
struct sp_token_list *sp_get_macro_arg(struct sp_macro_def *macro, struct sp_macro_args *args, int param_name_id);
